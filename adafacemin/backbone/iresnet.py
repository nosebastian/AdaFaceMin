...
__all__: list[str] = ['IR_18', 'IR_34', 'IR_50', 'IR_101', 'IR_152', 'IR_200', 'IR_SE_50', 'IR_SE_101', 'IR_SE_152', 'IR_SE_200', 'build_model']
...
def IR_101(input_size) -> Backbone:
...
def IR_152(input_size) -> Backbone:
...
def IR_200(input_size) -> Backbone:
...
def IR_SE_50(input_size) -> Backbone:
...
def IR_SE_101(input_size) -> Backbone:
...
def IR_SE_152(input_size) -> Backbone:
...
def IR_SE_200(input_size) -> Backbone:
...
def build_model(model_name='ir_50') -> Backbone:
